    ...
    <section className={classes.root}>
      <Grid container xs={12} justify="center" className={classes.test}>
        <Grid item xs={10} sm={10} md={10} lg={10} align="center">
          ...
          >
            The Addison TreeHouse is part of The DEC network and is a coworking
            space and 501c3 non-profit created to help entrepreneurs start,
            build, and grow companies through education, mentorship, and
            community.
          </Typography>
        </Grid>
      </Grid>
