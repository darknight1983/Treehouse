    ...
    <Grid container
      ...
      <Grid item xs={10}
        ...
        <Paper elevation={1}
          ...
          <Typography variant='title' component='h1' className={classes.contactTitle}>
            Nancy Hong
          </Typography>
            <Grid container justify="center" spacing={24} className={classes.contactSocial}>
              <Grid item>
                <IconBox>
            ...
            <Typography variant='subheading' component='h1' className={classes.contactDescription}>
